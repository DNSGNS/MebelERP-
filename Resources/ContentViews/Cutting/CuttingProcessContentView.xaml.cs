...
public partial class CuttingProcessContentView : ContentView
{
    private CuttingData ViewModel => BindingContext as CuttingData;

    public CuttingProcessContentView()
    {
        InitializeComponent();
    }
    ...
    private Frame CreateSheetUI(SheetLayout sheet, double edgeOffset)
    {
        ...
        {
            Text = $"Лист {sheet.SheetIndex}{colorText} ({sheet.SheetW}x{sheet.SheetH})",
            FontSize = 16,
