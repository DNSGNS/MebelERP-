...
public partial class LayoutReportContentView : ContentView
{
    // Удобный доступ к данным
    private CuttingData ViewModel => BindingContext as CuttingData;

    public LayoutReportContentView()
    {
        InitializeComponent();
    }
    ...
    private async void OnSaveReportClicked(object sender, EventArgs e)
    {
        try
        {
            ...
            service.GenerateReportLayout(tempFilePath, data);
