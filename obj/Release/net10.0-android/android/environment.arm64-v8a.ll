...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 148, ; uint32_t number_of_assemblies_in_apk
	i32 0, ; uint32_t bundled_assembly_name_width
	i32 36, ; uint32_t number_of_dso_cache_entries
	i32 1026, ; uint32_t number_of_aot_cache_entries
	i32 123, ; uint32_t number_of_shared_libraries
	i32 u0x0200031e, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06002133, ; uint32_t jnienv_initialize_method_token
	i32 u0x06002132, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [1026 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.IO.Pipelines.dll.so
		ptr null; void* handle
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x075869ca7007af29, ; from name: aot-MyApp1.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
		ptr null; void* handle
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.34_name, ; name: libaot-QuestPDF.dll.so
		ptr null; void* handle
	}, ; 84
	%struct.DSOCacheEntry {
		i64 u0x12e73d483788709d, ; from name: SkiaSharp.so
	...
	%struct.DSOCacheEntry {
		i64 u0x1625f73ad100b6d5, ; from name: QuestPDF.Report.dll.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
		ptr null; void* handle
	}, ; 98
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1a983d396afb3cf7, ; from name: aot-MyApp1
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x23bdee883cc42c3e, ; from name: libaot-MyApp1.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.17_name, ; name: libaot-Microcharts.Maui.dll.so
		ptr null; void* handle
	}, ; 148
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.ComponentModel.Annotations.dll.so
		ptr null; void* handle
	}, ; 153
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4edee358535e7945, ; from name: libaot-MyApp1
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x6346d7558f951091, ; from name: MyApp1.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x76cda2e21b3782b1, ; from name: MyApp1.dll.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x79a24c0d69b4d194, ; from name: libaot-QuestPDF.Report.dll.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x97caa2815abdc435, ; from name: MyApp1
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xa48d0bf00ca2bb89, ; from name: QuestPDF.Report.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xa4a44d97b6d5d10e, ; from name: aot-MyApp1.dll.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xa8872cc29f52e27a, ; from name: libaot-QuestPDF.Report.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xb5d3338d3eb20e76, ; from name: libaot-MyApp1.dll.so
		i64 u0xb5d3338d3eb20e76, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-MyApp1.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xbae41c296e624722, ; from name: libaot-QuestPDF.Report
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xc2b4d9f3adba7f18, ; from name: aot-QuestPDF.Report
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xc6962f706317ba1f, ; from name: QuestPDF.Report
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xca4e6adc910155f0, ; from name: aot-QuestPDF.Report.dll.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf28d30562cc05e52, ; from name: aot-QuestPDF.Report.so
		i64 u0x79a24c0d69b4d194, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.35_name, ; name: libaot-QuestPDF.Report.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.myapp1\00", align 1
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [21 x i8] c"libaot-MyApp1.dll.so\00", align 1
...
@.DSOCacheEntry.17_name = private unnamed_addr constant [31 x i8] c"libaot-Microcharts.Maui.dll.so\00", align 1
...
@.DSOCacheEntry.34_name = private unnamed_addr constant [23 x i8] c"libaot-QuestPDF.dll.so\00", align 1
@.DSOCacheEntry.35_name = private unnamed_addr constant [30 x i8] c"libaot-QuestPDF.Report.dll.so\00", align 1
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [48 x i8] c"libaot-System.ComponentModel.Annotations.dll.so\00", align 1
...
@.DSOCacheEntry.84_name = private unnamed_addr constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 1
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [34 x i8] c"libaot-System.Formats.Asn1.dll.so\00", align 1
@.DSOCacheEntry.88_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.Compression.Brotli.dll.so\00", align 1
@.DSOCacheEntry.89_name = private unnamed_addr constant [36 x i8] c"libaot-System.IO.Compression.dll.so\00", align 1
@.DSOCacheEntry.90_name = private unnamed_addr constant [34 x i8] c"libaot-System.IO.Pipelines.dll.so\00", align 1
@.DSOCacheEntry.91_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 1
