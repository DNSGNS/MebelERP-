...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [148 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2210304, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 18830968; uint32_t buffer_offset
	}, ; 145: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 19001976; uint32_t buffer_offset
	}, ; 146: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2288128, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 19023512; uint32_t buffer_offset
	} ; 147: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 21311640, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [21311640 x i8] zeroinitializer, align 16
